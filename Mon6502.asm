...
;    4-Nov-03 PO  Ported to experimental 6502 board (Invector Embedded Technologies)
;   18-Feb-09 PO  Updated a few comments for clarity and stored it in SVN
;                 Use DASM to assemble file
;   05-Mar-11 PO  Added support for SCN2681 UART and changed to a more 
;                 generic way of selecting UART and UART base address.
;
;============================================================================
;
...
;
S16450        EQU     UART_BASE       ;base of 16450 UART
...
SERIAL_TXDATA EQU   UART_BASE         ;ACIA WRITE DATA
SERIAL_RXDATA EQU   UART_BASE         ;ACIA READ DATA
SERIAL_RESET  EQU   UART_BASE+1       ;WRITE (STATUS) TO RESET ACIA
...
;===========================================================================
        SEG     CODE
; This section is just to create a 32KByte binary that is easy to download
; into a EPROM programer. If you have a smaller EPROM simply adjust the
; base address to match your device.
               org   $8000,$ff
               DC    $ff
...
#ENDIF
#IF UART_SCN2681
; Initialize the monitor to 38400, 8 bits no parity 1 stop bit
; First do a simple check that we have a working SCN2681 attached to the
; CPU bus.
